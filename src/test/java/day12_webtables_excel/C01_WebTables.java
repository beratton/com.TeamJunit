...
// 5. Tabloda kac tane bos olmayan cell (data) oldugunu yazdirin
        ...
        System.out.println("Bos olmayan hucre sayisi: "+ siraNo);
// 6. Tablodaki satir sayisini yazdirin
        List<WebElement> satirElementi=driver.findElements(By.xpath("//div[@class='rt-tr-group']"));
        System.out.println("Tablodaki satir sayisi: "+ satirElementi.size());
